...
return returnArr.length>1?returnArr:returnArr[0];};$.fn.carousel.defaults={hAlign:'center',vAlign:'center',hMargin:0.7,vMargin:0.2,frontWidth:205,frontHeight:400,carouselWidth:1100,carouselHeight:360,left:0,right:0,top:0,bottom:0,backZoom:0.9,slidesPerScroll:7,speed:500,buttonNav:'none',directionNav:false,autoplay:true,autoplayInterval:3000,pauseOnHover:true,mouse:false,shadow:false,reflection:false,reflectionHeight:0.2,reflectionOpacity:0.5,reflectionColor:'255,255,255',description:false,descriptionContainer:'.description',backOpacity:1,before:function(carousel){},after:function(carousel){}};})(jQuery);